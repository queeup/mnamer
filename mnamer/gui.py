...
class View(tk.Tk):
    def __init__(self):
        ...
        vsb = ttk.Scrollbar(
            self.file_list, orient=tk.VERTICAL, command=self.file_list.yview
        )
        ...
        self.match_listbox.pack(expand=tk.YES, fill=tk.BOTH, padx=5, pady=5)
        vsb = ttk.Scrollbar(
            self.match_listbox,
            orient=tk.VERTICAL,
...
class Controller:
    def __init__(self, model: Model, view: View, movie_mode: bool = True):
        ...
        self.view.help_menu.entryconfig(
            ...
            command=lambda: webbrowser.open_new(
                "https://github.com/jkwill87/mnamer/wiki"
            ),
        )
    ...
    def add_media(self, targets, mtype=None) -> bool:
        # selected = crawl(
        #     targets=targets,
    ...
    def set_listbox(self):
        ...
        for meta in self.model.meta:
            self.view.file_list.insert(tk.END, meta.file_path)
